...
public class BlogDaoDB implements BlogDao{
    @Autowired
    JdbcTemplate jdbc;
    private static String UPLOADED_FOLDER = "/Users/acetip/Desktop/finalatschool/com.example_blogPosts_jar_0.0.1-SNAPSHOT/src/main/resources/static//images// ";


//"D://Downloads//com.example_blogPosts_jar_0.0.1-SNAPSHOT//src//main//resources//static//images//";   // 
//"C://photos//";
    ...
    public Blog createBlog(Blog blog) {
        final String INSERT_BLOG = "INSERT INTO blog (title, paragraph, userID, categoryID, approval, date, imagePath) values (?,?,?,?,?,?,?);";
        
        jdbc.update(INSERT_BLOG, blog.getTitle(), blog.getText(), blog.getUser().getId(), blog.getCategory().getCategoryID(), blog.getIsApproved(), blog.getDate(), blog.getImagePath());
    ...
    public static final class BlogMapper implements RowMapper<Blog> {
        ...
        public Blog mapRow(ResultSet rs, int i) throws SQLException {
            ...
            blog.setImagePath(rs.getString("imagePath"));
            return blog;
        }
    }
